# Generated by Django 5.0.3 on 2024-05-28 08:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ICDCODE', models.CharField(default='N/A', max_length=255, null=True)),
                ('TEMP_GROUPID', models.CharField(max_length=255)),
                ('ACR_GROUPID', models.CharField(max_length=255)),
                ('DESCRIPTION', models.TextField()),
                ('EFF_DATE', models.DateField()),
                ('USERNAME', models.CharField(max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ACR_GROUPID', models.CharField(default='N/A', max_length=255, null=True)),
                ('DESCRIPTION', models.TextField()),
                ('EFF_DATE', models.DateField()),
                ('ACTIVE', models.CharField(choices=[('T', 'True'), ('F', 'False')], max_length=3)),
                ('END_DATE', models.DateField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('FIXED_COPAY', models.DecimalField(decimal_places=2, max_digits=10)),
